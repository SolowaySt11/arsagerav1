...
LECTURES = [
    {
        ...
        "description": "Первая лекция из курса Арсагеры по инвестициям.",
        "file_id": "CQACAgIAAxkBAAIBsmqQpNoNR85Hd-d7k6H6X9bAZt7zAAKxoQACjCeBSBw3muirYi02PQQ"
    },
    {
        "id": "lecture_2",
        "title": "📚 Лекция 2. Выбор инструментов сбережения",
        "description": "Вторая лекция из курса Арсагеры.",
        "file_id": "CQACAgIAAxkBAAIBwmqQqDo6Kbd9I-w4eBOJyf_sxlWYAAIGtQACjCeJSMOhD9XlrbtmPQQ"
    },
    {
        "id": "lecture_3",
        "title": "📚 Лекция 3. Инвестирование в долговые инструменты. Часть 1.",
        "description": "Третья лекция из курса Арсагеры.",
        "file_id": "CQACAgIAAxkBAAIBw2qQqJjdpV-xB-5sF2KIsXV_w8KeAAIHtQACjCeJSJZD8iu0Q9hePQQ"
    },
    {
        "id": "lecture_4",
        "title": "📚 Лекция 4. Инвестирование в долговые инструменты. Часть 2.",
        "description": "Четвёртая лекция из курса Арсагеры.",
        "file_id": "CQACAgIAAxkBAAIBymqQqooNh1S8sfyUDQMozz9O4k0YAAIRtQACjCeJSGnBrbrNNYTePQQ"
    },
    {
        "id": "lecture_5",
        "title": "📚 Лекция 5. Инвестирование в долговые инструменты. Часть 3.",
        "description": "Пятая лекция из курса Арсагеры.",
        "file_id": "CQACAgIAAxkBAAIBzGqQqsPOX9xzIk_fYISsJ9Bigb7KAAIQtQACjCeJSNjsYlqZmLGrPQQ"
    },
    {
        "id": "lecture_6",
        "title": "📚 Лекция 6. Инвестирование в долевые инструменты. Часть 1.",
        "description": "Шестая лекция из курса Арсагеры.",
        "file_id": "CQACAgIAAxkBAAIBzWqQrTs9GmUdeFvxYXYb4BS85w9VAAJ5ugACB6SBSK2OXi6ye3dLPQQ"
    },
    {
        "id": "lecture_7",
        "title": "📚 Лекция 7. Инвестирование в долевые инструменты. Часть 2.",
        "description": "Седьмая лекция из курса Арсагеры.",
        "file_id": "CQACAgIAAxkBAAIBzmqQrXm77or-mGUbBS7W5s9srdvSAAITtQACjCeJSGgFXAAB58n_Az0E"
    },
    {
        "id": "lecture_8",
        "title": "📚 Лекция 8. Инвестирование в долевые инструменты. Часть 3.",
        "description": "Восьмая лекция из курса Арсагеры.",
        "file_id": "CQACAgIAAxkBAAIBz2qQrbHEwpPbzfW-EGZXRv8hF3hVAAIYtQACjCeJSIWZ3zumNyFpPQQ"
    },
    {
        "id": "lecture_9",
        "title": "📚 Лекция 9. Инвестирование в долевые инструменты. Часть 4.",
        "description": "Девятая лекция из курса Арсагеры.",
        "file_id": "CQACAgIAAxkBAAIB0GqQrbrq6MURcu5-Co7GUqvRIjSmAAIZtQACjCeJSD3Cc_gbIF18PQQ"
    },
    {
        "id": "lecture_10",
        "title": "📚 Лекция 10. Структура портфеля. Диверсификация. Риск-менеджмент. Часть 1.",
        "description": "Десятая лекция из курса Арсагеры.",
        "file_id": "CQACAgIAAxkBAAIB0WqQrhrZyyXBMw0eD0JAUfV8pEVVAAIctQACjCeJSI2QIHXb555NPQQ"
    },
    {
        "id": "lecture_11",
        "title": "📚 Лекция 11. Структура портфеля. Диверсификация. Риск-менеджмент. Часть 2.",
        "description": "Одиннадцатая лекция из курса Арсагеры.",
        "file_id": "CQACAgIAAxkBAAIB0mqQrklBkXirSf8fa6eWzi3VjQIPAAIetQACjCeJSAvow5n_5zLnPQQ"
    },
    {
        "id": "lecture_12",
        "title": "📚 Лекция 12. Система управления капиталом. Блоки функций. Актуализация.",
        "description": "Двенадцатая лекция из курса Арсагеры.",
        "file_id": "CQACAgIAAxkBAAIB02qQrwEWsRZ-zHMN05sNi7sPGYwuAAKMugACB6SBSICf2exyYbwyPQQ"
    },
]
...
def main():
    ...
    print("🤖 Бот Арсагера с 12 лекциями запущен...")
    app.run_polling()
